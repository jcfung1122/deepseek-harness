...
import powerRemote from '@deepseek-ai/dsh-host-power/remote'
...
export type {} from '@deepseek-ai/dsh-host-power/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, powerRemote, messageFeedbackRemote,
    ]) {
