/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-power`.
 * @module @deepseek-ai/dsh-power/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-power'

/** Cordis companion plugin name. */
export const name = 'power-bundle-invariant'
